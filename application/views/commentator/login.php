...
<head>
	...
	<meta charset="utf-8"/>
	<title>CPL | Commentator Login</title>
						...
						<div class="kt-login__body">
							...
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign In To Commentator</h3>
								</div>
								<?php echo form_open('', 'id=kt_login_commentator'); ?>
								<div class="kt-login__form">
									...
									<div class="kt-login__actions">
										<button type="submit" id="kt_login_commentator_submit"
...
<script src="<?php echo base_url(); ?>assets/js/pages/custom/login/login-commentator.js" type="text/javascript"></script>
