...
<div class="kt-portlet">
	...
	<!--begin::Form-->
	<?php echo form_open_multipart('marketing_manager/matches/add_match_summary', 'class="kt-form kt-form--label-right"'); ?>
	<div class="kt-portlet__body">
		...
		<div class="form-group row">
			...
			<div class="col-lg-3">
				<label>Score:</label>
				<input type="text" class="form-control" name="first_team_score" placeholder="First Team Score"/>
			</div>

			<div class="col-lg-3">
				<label>Wickets:</label>
				<input type="text" class="form-control" name="first_team_wickets" placeholder="First Team Score"/>
			</div>
			...
			<div class="col-lg-3">
				...
				<input type="text" class="form-control" name="first_team_overs_played"
		...
		<div class="form-group row">
			...
			<div class="col-lg-3">
				...
				<input type="text" class="form-control" name="first_team_batting_player_1_score"
					   placeholder="Player 1 Score"/>
			</div>
			<div class="col-lg-3">
				<label>Batsman 1 Balls:</label>
				<input type="text" class="form-control" name="first_team_batting_player_1_balls"
		...
		<div class="form-group row">
			...
			<div class="col-lg-3">
				...
				<input type="text" class="form-control" name="first_team_batting_player_2_score"
					   placeholder="Player 2 Score"/>
			</div>
			<div class="col-lg-3">
				<label>Batsman 2 Balls:</label>
				<input type="text" class="form-control" name="first_team_batting_player_2_balls"
		...
		<div class="form-group row">
			...
			<div class="col-lg-3">
				<label>Score:</label>
				<input type="text" class="form-control" name="second_team_score" placeholder="Second Team Score"/>
			</div>

			<div class="col-lg-3">
				<label>Wickets:</label>
				<input type="text" class="form-control" name="second_team_wickets" placeholder="Second Team Wickets"/>
			</div>
