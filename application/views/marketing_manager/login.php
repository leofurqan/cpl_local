...
<head>
	...
	<meta charset="utf-8"/>
	<title>CPL | Marketing Manager Login</title>
							...
							<div class=" kt-login__logo">
								<a href="#">
									<img width="250px" height="250px"
										 src="<?php echo base_url(); ?>assets/media/cpl/cpl.png">
								</a>
							</div>

							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign In To Marketing Manager</h3>
								</div>
								<?php echo form_open('', 'id=kt_login_marketing_manager'); ?>
								<div class="kt-login__form">
									...
									<div class="kt-login__actions">
										<button type="submit" id="kt_login_marketing_manager_submit"
...
<script src="<?php echo base_url(); ?>assets/js/pages/custom/login/login-marketing_manager.js"
		type="text/javascript"></script>
