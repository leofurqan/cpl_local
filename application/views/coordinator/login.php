...
<head>
	...
	<meta charset="utf-8"/>
	<title>CPL | Coordinator Login</title>
						...
						<div class="kt-login__body">
							...
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign In To Coordinator</h3>
								</div>
								<?php echo form_open('', 'id=kt_login_coordinator'); ?>
								<div class="kt-login__form">
									...
									<div class="kt-login__actions">
										<button type="submit" id="kt_login_coordinator_submit"
...
<script src="<?php echo base_url(); ?>assets/js/pages/custom/login/login-coordinator.js" type="text/javascript"></script>
