				...
				<div class="kt-portlet__head-label">
										<span class="kt-portlet__head-icon">
                                             <svg xmlns="http://www.w3.org/2000/svg"
												  ...
												  version="1.1" width="25" height="25" x="0"
...
<g xmlns="http://www.w3.org/2000/svg">
			...
			<div class="kt-portlet__body">
				<table class="table table-striped table-bordered table-hover table-checkable" id="p_table">
					<thead>
					<tr>
						<th>#</th>
						<th>Image</th>
					...
					<?php if (!empty($team)) { ?>
						...
						foreach ($team as $t) { ?>
							<tr>
								...
								<td>
									<?php if ($t->image) { ?>
										<img width="36px;" src="<?php echo base_url('uploads/players/' . $t->image); ?>"/>
									<?php } else { ?>
