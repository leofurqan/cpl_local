						...
						<div class="kt-widget kt-widget--user-profile-1">
							...
							<div class="kt-widget__body">
								...
								<div class="kt-widget__items">
									...
									<a href="<?php echo base_url('team/players/overview/' . $player->id); ?>" class="kt-widget__item kt-widget__item--active">
									...
									<a href="<?php echo base_url('team/players/batting_stats/' . $player->id); ?>" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<div class="col-xl-12">
						<div class="kt-portlet">
							<div class="kt-portlet__head">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title">Player Information <small>Player personal informaiton</small></h3>
								</div>
								...
								<div class="kt-section kt-section--first">
									<div class="kt-section__body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<div class="kt-avatar kt-avatar--outline" id="kt_user_avatar">
														...
														<span class="kt-widget__data"><img style="border-radius: 50px" width="80px;"
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<input class="form-control" readonly type="text" value="<?php echo $player->player_name; ?>">
											</div>
										</div>
																		<div class="form-group row">
																			<label class="col-xl-3 col-lg-3 col-form-label">Display Name</label>
																			<div class="col-lg-9 col-xl-6">
																				<input class="form-control" readonly type="text" value="<?php echo $player->display_name; ?>">
																			</div>
																		</div>
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<div class="input-group">
													...
													<input class="form-control" readonly type="text" value="<?php echo $player->contact; ?>">
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9 col-xl-6">
												<div class="input-group">
													...
													<input class="form-control" readonly type="text" value="<?php echo $player->email; ?>">
												</div>
