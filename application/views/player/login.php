						...
						<div class="kt-login__body">
							...
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign In To Player</h3>
								</div>
								<?php echo form_open('', "id=kt_login_player"); ?>
								<div class="kt-login__form">
									...
									<div class="kt-login__actions">
										<button type="submit" id="kt_login_player_submit"
...
<script src="<?php echo base_url(); ?>assets/js/pages/custom/login/login-player.js" type="text/javascript"></script>
