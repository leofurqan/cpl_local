			...
			<div class="kt-widget kt-widget--user-profile-1">
				...
				<div class="kt-widget__body">
					...
					<div class="kt-widget__items">
						...
						<a href="<?php echo base_url('player/profile'); ?>" class="kt-widget__item kt-widget__item--active">
						...
						<a href="<?php echo base_url('player/profile/change_password'); ?>" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<div class="row">
		<div class="col-xl-12">
			<div class="kt-portlet">
				...
				<?php echo form_open_multipart('player/profile','class="kt-form kt-form--label-right"');?>
				<?php echo form_hidden('player_id', $player->id);?>
						...
						<div class="kt-section kt-section--first">
							<div class="kt-section__body">
									...
									<div class="col-lg-9 col-xl-6">
										<div class="kt-avatar kt-avatar--outline" id="kt_user_avatar">
											...
											<label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change avatar">
												<i class="fa fa-pen"></i>
												<input type="file" name="logo" accept=".png, .jpg, .jpeg" value="<?php echo base_url('uploads/players/' . $player->image); ?>">
											</label>
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-xl-6">
										<input class="form-control" name="player_name" type="text" value="<?php echo $player->player_name; ?>">
									</div>
								</div>
<!--								<div class="form-group row">-->
<!--									<label class="col-xl-3 col-lg-3 col-form-label">Last Name</label>-->
<!--									<div class="col-lg-9 col-xl-6">-->
<!--										<input class="form-control" type="text" value="--><?php //echo $user->last_name; ?><!--">-->
<!--									</div>-->
<!--								</div>-->
								<div class="form-group row">
									...
									<div class="col-lg-9 col-xl-6">
										<div class="input-group">
											...
											<input id="contact" name="contact" type="number" class="form-control" value="<?php echo $player->contact; ?>" placeholder="Phone" aria-describedby="basic-addon1">
										</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-xl-6">
										<div class="input-group">
											...
											<input id="email" name="email" type="text" class="form-control" value="<?php echo $player->email; ?>" placeholder="Email" aria-describedby="basic-addon1">
										</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-xl-6">
										<input id="cnic" class="form-control" name="cnic" type="text" value="<?php echo $player->cnic; ?>">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-xl-3 col-lg-3 col-form-label">Playing Status</label>
									<div class="col-lg-9 col-xl-6">
										<select class="form-control" name="playing_status">
											<option>Select playing status</option>
											<?php
											foreach ($playing_statuses as $playing_status) { ?>
												<option value="<?php echo $playing_status->id; ?>"
														<?php if ($player->playing_status === $playing_status->id) {
															echo "selected";
														} ?>><?php echo $playing_status->name; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-xl-3 col-lg-3 col-form-label">Batting Style</label>
									<div class="col-lg-9 col-xl-6">
										<select class="form-control" name="batting_style">
											<option>Select batting style</option>
											<?php
											foreach ($batting_styles as $batting_style) { ?>
												<option value="<?php echo $batting_style->id; ?>"
														<?php if ($player->batting_style === $batting_style->id) {
															echo "selected";
														} ?>><?php echo $batting_style->short_name; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-xl-3 col-lg-3 col-form-label">Bowling Style</label>
									<div class="col-lg-9 col-xl-6">
										<select class="form-control" name="bowling_style">
											<option>Select bowling style</option>
											<?php
											foreach ($bowling_styles as $bowling_style) { ?>
												<option value="<?php echo $bowling_style->id; ?>"
														<?php if ($player->bowling_style === $bowling_style->id) {
															echo "selected";
														} ?>><?php echo $bowling_style->short_name; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-xl-3 col-lg-3 col-form-label">Kit Size</label>
									<div class="col-lg-9 col-xl-6">
										<select class="form-control" name="kit_size">
											<option>Select kit size</option>
											<?php
											foreach ($kit_sizes as $kit_size) { ?>
												<option value="<?php echo $kit_size->id; ?>"
														<?php if ($player->kit_size === $kit_size->id) {
															echo "selected";
														} ?>><?php echo $kit_size->player_size; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
									...
									<div class="col-lg-9 col-xl-6">
										<div class="kt-radio-inline ">
											<label class="kt-radio kt-radio--solid">
												<input type="radio" name="status" checked value="1"<?php if ($player->status == '1'){
													echo "checked";
												} ?>> Active
												<span></span>
											</label>
											<label class="kt-radio kt-radio--solid">
												<input type="radio" name="status" value="0"<?php if($player->status == '0'){
													echo 'checked';
												} ?>> Inactive
												<span></span>
											</label>
