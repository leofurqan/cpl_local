				...
				<table class="table table-striped table-bordered table-hover table-checkable" id="kt_table_1">
					...
					foreach ($tournaments as $tournament) {
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									<a href="<?php echo base_url('admin/tournaments/edit/' . $tournament->id) ?>"
									...
									<a href="<?php echo base_url('admin/tournaments/reserve_ground/' . $tournament->id) ?>"
									   class="btn btn-outline-primary btn-elevate btn-elevate-air btn-icon btn-sm" data-container="body"
									   data-toggle="kt-tooltip" data-placement="top" title="Ground Reservation">
										<i class="la la-registered"></i></a>
