...
<div class="kt-portlet">
	...
	<!--begin::Form-->
	<?php echo form_open_multipart('admin/grounds/add_ground','class="kt-form kt-form--label-right"');?>
		<div class="kt-portlet__body">
			...
			<div class="form-group row">
				<div class="col-xl-4 col-lg-4 col-sm-4">
					...
					<input name="ground_name" type="text" class="form-control" placeholder="Enter your ground name" required>
				...
				<div class="col-xl-4 col-lg-4 col-sm-4">
					...
					<div class="input-group">
						...
						<input name="ground_manager" type="text" class="form-control" placeholder="Enter your name" required>
					</div>
			...
			<div class="form-group row">
				<div class="col-xl-4 col-lg-4 col-sm-4">
					...
					<input id="longitude" name="longitude" type="number" step="any" maxlength="12" class="form-control" placeholder="Enter Longitude" required>
					<div>
				...
				<div class="col-xl-4 col-lg-4 col-sm-4">
					...
					<input id="latitude" name="latitude" type="number" step="any" maxlength="12" class="form-control" placeholder="Enter Latitude" required>
					<div>
...
<script>
	$('#email').change(function () {
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url("admin/grounds/check_email");?>',
			data: {
				'email': $(this).val()
			},
			datatype: 'JSON',
...
<script>
	$('#contact').change(function () {
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url("admin/grounds/check_contact");?>',
			data: {
				'contact': $(this).val()
			},
			datatype: 'JSON',
