				...
				<div class="kt-portlet__head">
					...
					<div class="kt-portlet__head-toolbar">
						...
						<button type="button" class="btn btn-warning m-1" data-toggle="modal"
								data-target="#modal_print"><i class="la la-filter"></i>Filter
						</button>
					</div>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Tournament:</label>
										<div class="col-lg-9">
											<select name="tournament_id" type="text" id="tournament"
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Tournament:</label>
										<div class="col-lg-9">
											<select name="tournament_id" type="text" id="filter_tournament"
													class="form-control kt-select2" required>
									...
									<table class="table table-striped- table-bordered text-center table-hover table-checkable"
										   id="table_grounds">
										<thead>
										<tr>
...
<script>
	$('document').ready(function () {
		...
		var e = JSON.parse('<?php echo json_encode($reserve_grounds); ?>');
		var events = [];
