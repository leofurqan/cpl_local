					...
					<div class="kt-login__container">
						<div class="kt-login__body">
							...
							<div class="kt-login__signin">
								...
								<?php echo form_open('', 'id=kt_login_admin'); ?>
								<div class="kt-login__form">
									...
									<div class="kt-login__actions">
										<button type="submit" id="kt_login_admin_submit"
...
<script src="<?php echo base_url(); ?>assets/js/pages/custom/login/login-admin.js" type="text/javascript"></script>
